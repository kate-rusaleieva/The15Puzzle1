$(function() {
    ...
    function newgame(){
        ...
        $('.block').each(function(){    
            if($(this).text()==''){
                row = Math.ceil((parseInt($(this).css('top'))+1) / 70); 
                col = Math.ceil((parseInt($(this).css('left'))+1) / 70);
            };
        });
        var blockDirection;
        var iteration = 0;
    ...
    $('.block').on('click', function(){
        ...
        row1 = Math.ceil((parseInt($(this).css('top'))+1) / 70);
        col1 = Math.ceil((parseInt($(this).css('left'))+1) / 70);
